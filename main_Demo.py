...
# Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=text%3A%28apple+AND+grandma+AND+pear%29', rerun=True)#single scraping
Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=text%3A%28apple+AND+grandma%29&fq=culture_level_samples%7CSCCS%3Bculture_level_samples%7CSRS', rerun=False, headless=True)# rapid 7 doc text with filters
# #
