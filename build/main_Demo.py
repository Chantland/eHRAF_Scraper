...
Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=cultures%3A%22Serbs%22+AND+text%3AApple') #standard Apple one culture
# Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=subjects%3A%28%22sickness%22%29&fq=culture_level_samples%7CPSF') # Demo scraper for 750 (actually does 750-759)
...
# Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=text%3A%28apple+AND+grandma%29&fq=culture_level_samples%7CSCCS%3Bculture_level_samples%7CSRS', headless=False)# rapid 7 doc text with filters
# Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=subjects%3A%28%22preventive+medicine%22+OR+%22theory+of+disease%22%29&fq=culture_level_samples%7CPSF') # check OCM 751 and 753 with PSF filter
# Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=subjects%3A%28%22preventive+medicine%22+OR+%22theory+of+disease%22%29') # check OCM 751 and 753 without PSF filter
# Scraper1 = Scraper(url=r'https://ehrafworldcultures.yale.edu/search?q=subjects%3A%28%22preventive+medicine%22+AND+%22sorcery%22+AND+%22theory+of+disease%22%29&fq=culture_level_samples%7CPSF')


Scraper1.region_scraper(rerun=True)   # Scrape the region
